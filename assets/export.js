      ...
      // القيمة تُحاط بعلامتي LRM (U+200E) لأن الفقرة في القالب من اليمين
      // لليسار، فتضع Word علامة الدرجة يسار الرقم (°95). العلامتان تجبران
      // النص على الاتجاه اللاتيني فيظهر 95° كما هو مطلوب.
      function withDegreeSign(value) {
        if (!value) return "";
        if (!/\d/.test(value)) return value;
        const withSign = value.includes("°") ? value : value + "°";
        return "\u200E" + withSign.replace(/[\u200E\u200F]/g, "") + "\u200E";
      }
