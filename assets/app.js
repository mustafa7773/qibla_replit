  ...
  <svg width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
    ...
    <g filter="url(#kaabaGlow)">
      ...
      // ======================================================================
      // فتح الأداة بمسجد محدد من أداة وقت العمل
      //
      // الرابط يحمل الإحداثيات ونظام الإسناد والنطاق، فتُملأ الحقول ويُحسب
      // الاتجاه تلقائياً — ثم يُنزّل المستخدم تقرير Word من مساره المعتاد،
      // بصورة الخريطة وكل حقول التقرير، بلا تكرار أي منطق هنا.
      // ======================================================================
      ...
      (function loadFromUrl() {
        ...
        if (datum === "psd93" || datum === "wgs84utm") {
          document.getElementById("datum").value = datum;
        }

        document.getElementById("pointsInput").value = e.toFixed(2) + ", " + n.toFixed(2);

        // نُعطي بقية السكربتات فرصة للتهيئة قبل الضغط على الحساب
        setTimeout(() => {
          document.getElementById("computeBtn").click();
          ...
          // نملأ اسم المسجد في حقول التقرير إن كانت ظاهرة بعد الحساب
          setTimeout(() => {
            const village = document.getElementById("villagePlotInput");
            if (village && !village.value.trim()) village.value = name;
          }, 400);
        }, 300);
      })();
